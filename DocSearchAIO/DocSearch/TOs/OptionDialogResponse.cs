...
{
    public record OptionDialogResponse(bool FilterWord, bool FilterExcel, bool FilterPowerpoint, bool FilterPdf,
        int ItemsPerPage)
    {
        ...
        public static implicit operator OptionDialogResponse(OptionDialogRequest request) => new(
            request.FilterWord, request.FilterExcel, request.FilterPowerpoint, request.FilterPdf,
